...
class JsonSerializationTest : FreeSpec({
    ...
    "Server Request" {
        ...
        itemRequests[DRIVING_PRIVILEGES] shouldBe true
    ...
    "Server Response" {
        ...
        mdl.issueDate shouldBe LocalDate.parse("2019-10-20")
        mdl.expiryDate shouldBe LocalDate.parse("2024-10-20")
        mdl.licenceNumber shouldBe "123456789"
        mdl.drivingPrivileges shouldHaveSize 2
        mdl.drivingPrivileges shouldContain DrivingPrivilege(
            vehicleCategoryCode = "A",
            issueDate = LocalDate.parse("2018-08-09"),
            expiryDate = LocalDate.parse("2024-10-20")
        )
